...
N_PARTICLES = 50
RADIUS = 5
SPEED = 500 # initial speed in px/sec
MARGIN = 40
TRAIL_DURATION =10 # seconds
GRAVITY = 00      # px/sec^2 (tune for stronger/weaker gravity)
...
pygame.display.set_caption("Gas Particle Simulation with Gravity & Trails")
...
def hud():
    screen.blit(font.render(f"N={N_PARTICLES} | Trail={TRAIL_DURATION}s | g={GRAVITY}", True, HUD), (10, 10))
